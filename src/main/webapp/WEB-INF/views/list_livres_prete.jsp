...
<p> liste des livres pretes </p>			
<jsp:useBean id="listeLivrePretes" class="java.util.ArrayList" scope="session"></jsp:useBean>
	<div class="row">
		<c:forEach items="${listeLivrePretes}" var="livre" varStatus="test">
			<div class="col-xs-4">
